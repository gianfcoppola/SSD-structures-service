...
public class CentroSportivoController {
    ...
    public String datiCentroSportivo(Model model){
    ...
    public String analisiDatiPrenotazioni(Model model){
    ...
    public String analisiDatiAbbonamenti(Model model){
    ...
    public String analisiIncassiCentroSportivo(Model model){
